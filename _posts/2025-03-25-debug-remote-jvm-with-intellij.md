...
![Archi debogueur avec tunnel SSH](https://github.com/FBibonne/blog/blob/main/assets/debug-remote-jvm-with-intellij/debogueurTunnelSSH.png?raw=true)
...
![Vue débogage en local](https://github.com/FBibonne/blog/blob/main/assets/debug-remote-jvm-with-intellij/debugLocal.png?raw=true)
...
en cliquent sur ![l'icône en forme d'insecte](https://github.com/FBibonne/blog/blob/main/assets/debug-remote-jvm-with-intellij/bug.png?raw=true) :
L'IDE se connecte à la JVM distante et la vue de débogage se met en place :
![Vue débogage en local](https://github.com/FBibonne/blog/blob/main/assets/debug-remote-jvm-with-intellij/debug1.png?raw=true)
...
![bouléen stop à true](https://github.com/FBibonne/blog/blob/main/assets/debug-remote-jvm-with-intellij/debug3.png?raw=true)
